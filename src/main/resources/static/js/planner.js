...
nameModal.addEventListener('show.bs.modal', function (event) {
  ...
  // Update the modal's content.
    var modalTitle = nameModal.querySelector('.modal-title')
    var modalBodyInput = nameModal.querySelector('.modal-body input')
})
...
function saveDay() {
    ...
    const dayNameElement = document.createElement("input")
    dayNameElement.setAttribute('type', 'hidden')
    dayNameElement.setAttribute('name', 'dayName')
    dayNameElement.setAttribute('value', document.getElementById("day-name").value)
    document.getElementById("eventForm").appendChild(dayNameElement)
